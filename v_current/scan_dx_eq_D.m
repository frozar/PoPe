...
case 0 % custom
  ...
  %----------------------------------
  Nx_range = [16 32 64 128 256 512 1024 2048]; % number of points in space
  dt_range = 0.005;%0.01*2.^[0:-1:-3]; % time step for computation
  dt_diag_range = 0.05; % time step for diagnostics
