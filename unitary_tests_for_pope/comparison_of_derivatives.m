...
% plot(x,y_sec_fft,'g');
% axis tight
% legend('y','\partial_x y','\partial_x^2 y')
% %axis square
...
axis tight
legend('error of fft','of df1 non periodic','of df1 periodic','of df2 non periodic','of df2 periodic','of df3 non periodic','of df3 periodic')
%axis square
